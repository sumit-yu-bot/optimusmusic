...
async def thumb_init(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("AnonX/assets/anonx.png")
            ...
            # fonts
            font1 = ImageFont.truetype('AnonX/Utilities/font.ttf', 30)
            font2 = ImageFont.truetype('AnonX/Utilities/font.ttf', 70)
            font3 = ImageFont.truetype('AnonX/Utilities/font.ttf', 40)
            font4 = ImageFont.truetype('AnonX/Utilities/font.ttf', 35)

            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "OPTIMUS MUSIC", fill="white", font = font1, align ="left") 
